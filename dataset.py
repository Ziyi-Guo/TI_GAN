# Modified version of MNIST DataReader,
# Trying in getting the imgages and labels with desired calss
#
#
...
def read_data_sets(train_dir,
    ...
    for i in range(10):
        temp_train = train_images[train_labels == i]
        temp_train = temp_train[0:sample_vol]
        if i == 0:
            train = temp_train
        else:
            train = numpy.vstack((train, temp_train))
